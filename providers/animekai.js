...
// VERSION: 8.0 (Bugfix: Fixed Stream Array Concatenation)
...
// CONFIG: Allowed Servers (Only show reliable ones)
        ...
        .then(function(result) {
            ...
            .then(function(servers) {
                ...
                return Promise.allSettled(serverPromises).then(function(results) {
                    ...
                    // BUGFIX: Handle resolutionResult.streams correctly!
                    return resolveMultipleM3U8(m3u8Links).then(function(resolutionResult) {
                        // Extract streams and subtitles from the object resolutionResult
